...
export const metadata: Metadata = {
  ...
  description:
    "Термовизиска инспекција за откривање на топлотни загуби, влажни зони и скриени дефекти. Прецизни термални мапи за оптимизација на енергетски перформанси.",
};
...
const features = [
  {
    ...
    description:
      "Снимање со висококвалитетна термовизиска камера која детектира температурни разлики помали од 0.05°C.",
  },
  {
    title: "Откривање на топлотни загуби",
    description:
      "Прецизно лоцирање на точките на губење на топлина во ѕидови, прозорци, покриви и темели.",
  },
  {
    title: "Анализа на влага",
    description:
      "Идентификација на скриена влага во ѕидовите и конструкцијата пред да предизвика видливи оштетувања.",
  },
  {
    title: "Енергетски аудит",
    description:
      "Комплетен преглед на енергетската ефикасност на зградите со препораки за подобрување.",
  },
  {
    title: "Индустриска инспекција",
    description:
      "Откривање на прегреани компоненти во електрични системи, машини и процесни цевководи.",
  },
  {
    title: "Документирање за сертификати",
    description:
      "Детални извештаи кои можат да се користат за добивање на енергетски сертификати и субвенции.",
  },
];
...
const processSteps = [
  {
    ...
    description:
      "Преглед на документација, временски услови и специфики на објектот за оптимален термален скен.",
  },
  {
    number: 2,
    title: "Термален скен",
    description:
      "Систематско термовизиско снимање на целиот объект во оптимални временски услови.",
  },
  {
    number: 3,
    title: "Анализа на податоци",
    description:
      "Обработка на термалните слики и идентификација на проблематичните зони и аномалии.",
  },
  {
    number: 4,
    title: "Извештај",
    description:
      "Детален извештај со термални мапи, анализа на загуби и конкретни препораки за санација.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-white/50">
                Голем дел од енергетските загуби во зградите се невидливи за
                голото око. Термовизијата ги открива:
              </p>
