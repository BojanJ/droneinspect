  ...
  return (
    <>
      ...
      <ParallaxSection
        ...
        description="Со DJI Mavic 3 Pro и термовизиска камера, DroneInspect обезбедува невидена прецизност во инспекцијата на индустриски инсталации, далеководи и обновливи енергетски системи. Откријте проблеми пред да станат катастрофи."
